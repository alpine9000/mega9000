...
extern unsigned draw_frame_sprite_used;
extern unsigned draw_frame_sprite_max;
extern unsigned short (*draw_palette_debug_color)(unsigned index, unsigned short color);
